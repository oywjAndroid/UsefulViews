package com.oywj.usefulviews.ui.views.discrete;
...
import com.oywj.usefulviews.ui.views.discrete.transform.DiscreteScrollItemTransformer;
import com.oywj.usefulviews.ui.views.discrete.util.ScrollListenerAdapter;
...
public class DiscreteScrollView extends RecyclerView {
    ...
    public void setLayoutManager(LayoutManager layout) {
        if (layout instanceof DiscreteScrollLayoutManager) {
            ...
            throw new IllegalArgumentException("layout can only be DiscreteScrollLayoutManager.");
        }
    }
